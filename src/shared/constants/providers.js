...
export const WEB_COOKIE_PROVIDERS = {
  ...
  "devin-web": { id: "devin-web", alias: "dw", name: "Devin Web (Claude Opus 4.7)", icon: "smart_toy", color: "#7C3AED", textIcon: "DW", website: "https://app.devin.ai", authType: "cookie", authHint: "Paste your full app.devin.ai cookie header (must include auth1_session) OR just your auth1_xxx bearer token. 1 Devin account = 1 connection.", serviceKinds: ["llm"] },
};
